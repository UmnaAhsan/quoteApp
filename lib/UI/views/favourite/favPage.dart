...
import 'package:quote_app/UI/views/Screens/imageViewModel.dart';
...
class FavoritePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<ImageViewModel>.reactive(
      ...
      builder: (context, model, child) {
        final favoriteItems =
            model.quoteItems.where((item) => item.isFavorite).toList();
  ...
  Widget _buildFavoriteItem(
      BuildContext context, QuoteData item, ImageViewModel model) {
    return Container(
